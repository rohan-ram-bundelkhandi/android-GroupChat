...
public class DBAdapter {
    ...
    public static final String KEY_RECEIVER_IMEI   = "receiver_imei";
    ...
    public static final String KEY_USER_TIME="created_at";
    ...
    private static final String USER_CREATE =
            "create table tbl_user(_id integer primary key autoincrement,user_name text not null,user_imei text not null,user_message text not null,created_at text not null);";
    ...
    public static void addUserData(UserData uData) {
        try{
            ...
            //    String to_imei= sqlEscapeString(uData.getToIMEI());
            //    String receiver_name= sqlEscapeString(uData.getReceiverName());
            ...
            cVal.put(KEY_USER_TIME,time);
            //    cVal.put(KEY_RECEIVER_IMEI, to_imei);
            //    cVal.put(KEY_RECEIVER_NAME,receiver_name);
    ...
    public static String getUserName(String imei)
    {
        ...
        Cursor cursor = db.query(DEVICE_TABLE, new String[] {KEY_DEVICE_NAME }, KEY_DEVICE_IMEI + "=?",
                new String[] { String.valueOf(imei) }, null, null, null, null);
        if (cursor != null)
            cursor.moveToFirst();
    ...
    // Getting users Count
    public static List<UserData> getUserIMEIMessage(String senderIMEI,String receiverIMEI) {

        Log.d("Message test test1","hh");

        List<UserData> contactList = new ArrayList<UserData>();
        // Select All Query
        //    String selectQuery = "SELECT  * FROM " + USER_TABLE+" where user_name="+sender+" and receiver_name="+receiver;

        final SQLiteDatabase db = open();

        Cursor cursor = db.query(USER_TABLE, new String[]{KEY_ID, KEY_USER_NAME, KEY_USER_IMEI, KEY_USER_MESSAGE, KEY_RECEIVER_IMEI, KEY_RECEIVER_NAME}, (KEY_USER_IMEI + "=? and " + KEY_RECEIVER_IMEI + "=?") + " or " + (KEY_USER_IMEI + "=? and " + KEY_RECEIVER_IMEI + "=?"),
                new String[]{String.valueOf(senderIMEI), String.valueOf(receiverIMEI), String.valueOf(receiverIMEI), String.valueOf(senderIMEI)}, null, null, null, null);

        ///    Cursor cursor = db.query(USER_TABLE, new String[]{KEY_ID, KEY_USER_NAME, KEY_USER_IMEI, KEY_USER_MESSAGE, KEY_RECEIVER_IMEI, KEY_RECEIVER_NAME,KEY_USER_EMAIL}, KEY_USER_EMAIL + "=?",
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                data.setToIMEI(cursor.getString(4));
                data.setReceiverName(cursor.getString(5));
    ...
    public static List<UserData> getUserMessage() {
        ...
        Cursor cursor = db.rawQuery(countQuery, null);
//         Cursor cursor = db.query(USER_TABLE, new String[]{KEY_ID, KEY_USER_NAME, KEY_USER_IMEI, KEY_USER_MESSAGE}, KEY_USER_NAME+ "=?",
//                new String[]{String.valueOf(senderName)}, null, null, null, null);
